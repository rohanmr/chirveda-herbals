      ...
      <div className="container mx-auto px-4 py-8 lg:py-10 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right" className="space-y-6">
            ...
            {/* CTA Buttons */}
            <div className="flex justify-center md:justify-start flex-row gap-4 pt-2">
              <Link
                to="/products"
                className="bg-green-600 text-white px-6 py-4 sm:px-8 sm:py-4 rounded-full font-bold text-lg hover:bg-green-500 shadow-lg transform hover:scale-105 transition text-center"
              >
              ...
              <Link
                to="/about"
                className="border border-green-600 text-green-700 px-6 py-4 md:px-8 md:py-4 rounded-full font-bold text-lg hover:bg-green-600 hover:text-white shadow-md transform hover:scale-105 transition text-center"
              >
            ...
            {/* Highlights */}
            <div className="grid grid-cols-3 sm:grid-cols-3 gap-0.5 sm:gap-6 pt-8 text-center text-gray-800">
              <div>
                <div className="text-base sm:text-3xl font-bold text-green-600">
                  100%
                </div>
                <div className="text-sm sm:text-lg">Natural Ingredient</div>
              </div>
              <div>
                <div className="text-base sm:text-3xl font-bold text-green-600">
                  500+
