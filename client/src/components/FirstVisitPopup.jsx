        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 px-4">
            <div className="bg-white w-full max-w-md text-center relative rounded-xl shadow-xl overflow-hidden animate-[zoomIn_.3s_ease]">
                ...
                <div className="p-6 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-semibold mb-2">YOU WILL GET</h2>
                    ...
                    {!claimed ? (
                        <>
                            ...
                            <button
                                ...
                                className={`w-full text-white font-semibold py-3 rounded-md tracking-wide active:scale-95 transition
        ${emailError || !email ? "bg-gray-300 cursor-not-allowed" : "bg-green-600 hover:bg-green-700"}`}
                            >
                                CLAIM OFFER
                            </button>
                        </>
